      ...
      <Accordion defaultActiveItems={['basicInformation']}>
        <AccordionItem itemName="basicInformation">
          <AccordionHeader
            ...
            closeIcon={<DropdownArrow isRotate color="gray200" />}
          >
            <Text typography="t5">기본정보</Text>
          </AccordionHeader>
          <AccordionBody
          ...
          >
            <Flex>
              ...
              <Text color="gray300" typography="t6" className={cx('infoDescription')}>불스원 블랙홀 탈취제</Text>
            </Flex>
            <Flex>
              <Text typography="t7" className={cx('infoTitle')}>업체명</Text>
              <Spacing size={8} direction="vertical" />
              <Text color="gray300" typography="t6" className={cx('infoDescription')}>(주)불스원/직접생산</Text>
            </Flex>
            <Flex>
              <Text typography="t7" className={cx('infoTitle')}>제품구분</Text>
              <Spacing size={8} direction="vertical" />
              <Text color="gray300" typography="t6" className={cx('infoDescription')}>대표</Text>
            </Flex>
            <Flex>
              <Text typography="t7" className={cx('infoTitle')}>품목</Text>
              <Spacing size={8} direction="vertical" />
              <Text color="gray300" typography="t6" className={cx('infoDescription')}>탈취제/방향 - 탈취제품</Text>
            </Flex>
            <Flex>
              <Text typography="t7" className={cx('infoTitle')}>제조구분</Text>
              <Spacing size={8} direction="vertical" />
              <Text color="gray300" typography="t6" className={cx('infoDescription')}>제포</Text>
            </Flex>
            <Flex>
              <Text typography="t7" className={cx('infoTitle')}>제조방식</Text>
              <Spacing size={8} direction="vertical" />
              <Text color="gray300" typography="t6" className={cx('infoDescription')}>직접생산</Text>
            </Flex>
            <Flex>
              <Text typography="t7" className={cx('infoTitle')}>중량</Text>
              <Spacing size={8} direction="vertical" />
              <Text color="gray300" typography="t6" className={cx('infoDescription')}>20~100(g)</Text>
            </Flex>
            <Flex>
              <Text typography="t7" className={cx('infoTitle')}>신고번호</Text>
              <Spacing size={8} direction="vertical" />
              <Text color="gray300" typography="t6" className={cx('infoDescription')}>GB23-13-0401</Text>
            </Flex>
          </AccordionBody>
        </AccordionItem>
        <AccordionItem itemName="productDetails" className={cx('accordionItem')}>
          ...
          >
            <Flex align="flex">
              ...
              <Spacing size={8} direction="vertical" />
              <Text color="gray300" typography="t6" className={cx('infoDescription')}>리날로올, (E)-3,7-Dimethyl-2,6-octadien-1-ol,2-Methoxy-4-(2-propenyl)phenol; Eugenol, 4-Allyl-2-methoxyphenol, 4-Allyguaiacol,3,7-Dimethyl-6-octen-1-ol; Citronellol,d-리모넨,p-멘타-1,8-다이엔,리날로올,시트랄,3,7,7-트리메틸바이사이클로[4.1.0]헵-3-텐,d-리모넨,p-멘타-1,8-다이엔,아세트산 에틸</Text>
            </Flex>
            <Flex>
              <Text typography="t7" className={cx('infoTitle')}>제품용도</Text>
              <Spacing size={8} direction="vertical" />
              <Text color="gray300" typography="t6" className={cx('infoDescription')}>자동차용-실내용,일반용-실내공간용,일반용-밀폐공간용-옷장, 신발장</Text>
            </Flex>
            <Flex>
              <Text typography="t7" className={cx('infoTitle')}>주의사항</Text>
              <Spacing size={8} direction="vertical" />
              <Text color="gray300" typography="t6" className={cx('infoDescription')}>사용하시기 전에 표시 사항 및 사용방법을 확인하고 사용 하시오.</Text>
            </Flex>
            <Flex>
              <Text typography="t7" className={cx('infoTitle')}>응급조치</Text>
              <Spacing size={8} direction="vertical" />
              <Text color="gray300" typography="t6" className={cx('infoDescription')}>피부자극 반응 또는 붉은 반점이 나타나면 의학적 조치를 받으시오.</Text>
            </Flex>
          </AccordionBody>
        </AccordionItem>
      </Accordion>
